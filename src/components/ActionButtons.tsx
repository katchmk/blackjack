...
export function ActionButtons({
  ...
  const baseBtn = "min-w-24 px-6 py-3 text-base font-bold border-none rounded-lg cursor-pointer transition-all text-white disabled:opacity-40 disabled:cursor-not-allowed disabled:translate-y-0"
